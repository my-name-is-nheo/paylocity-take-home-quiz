...
const Button: FC<{
  ...
  const colorClassName: Record<ButtonColor, string> = {
    ...
    [ButtonColor.Green]: `mt-3 justify-center rounded-md bg-green-400 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-black-300 hover:bg-green-700 sm:mt-0 sm:w-auto ${className}`,
    ...
    [ButtonColor.White]: `mt-3 justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-black-300 hover:bg-red-50 sm:mt-0 sm:w-auto ${className}`,
  };
